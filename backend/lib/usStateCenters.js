/** Approximate geographic centers by state postal code (for map pin placement). */
...
export function offsetCoords(state, indexInState) {
...
export function photoUrlFromGovTrackLink(link) {
